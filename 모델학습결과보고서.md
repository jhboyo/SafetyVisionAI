...
![Training Results](models/ppe_detection/results.png)
...
![Confusion Matrix](models/ppe_detection/confusion_matrix.png)
*그림 2: 혼동 행렬 (절대값) - 클래스별 예측 결과*

![Confusion Matrix Normalized](models/ppe_detection/confusion_matrix_normalized.png)
...
![PR Curve](models/ppe_detection/BoxPR_curve.png)
*그림 4: Precision-Recall 곡선 - 클래스별 AP 성능*

![F1 Curve](models/ppe_detection/BoxF1_curve.png)
*그림 5: F1-Confidence 곡선 - 최적 임계값 선택*

![Precision Curve](models/ppe_detection/BoxP_curve.png)
*그림 6: Precision-Confidence 곡선 - Confidence 증가에 따른 정확도 향상*

![Recall Curve](models/ppe_detection/BoxR_curve.png)
...
![Val Batch 0 Labels](models/ppe_detection/val_batch0_labels.jpg)
*그림 8: 검증 데이터 Batch 0 - 실제 라벨 (Ground Truth)*

![Val Batch 0 Predictions](models/ppe_detection/val_batch0_pred.jpg)
*그림 9: 검증 데이터 Batch 0 - 모델 예측 결과*

![Val Batch 1 Labels](models/ppe_detection/val_batch1_labels.jpg)
*그림 10: 검증 데이터 Batch 1 - 실제 라벨 (Ground Truth)*

![Val Batch 1 Predictions](models/ppe_detection/val_batch1_pred.jpg)
